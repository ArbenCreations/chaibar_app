...
import 'package:ChaatBar/model/main_repository.dart';
...
import '../model/response/rf_bite/ErrorResponse.dart';
...
import '../model/response/rf_bite/dashboardDataResponse.dart';
import '../model/response/rf_bite/getCouponDetailsResponse.dart';
...
class MainViewModel with ChangeNotifier {
  ...
  Future<void> signUpData(String value, SignUpRequest signUpRequest) async {
    ...
    try {
      ...
      if (signUpInitializeResponse.status == 200 ||
        ...
        _apiResponse = ApiResponse.error(signUpInitializeResponse.message);
      }
    } catch (e) {
      _apiResponse = ApiResponse.error(e.toString());
      print("signInResponse $e");
  ...
  Future<void> fetchDashboardData(String value, int? vendorId) async {
    ...
    try {
      ...
      print("Yess" + dashboardDataResponse.message.toString());
  ...
  Future<void> fetchCategoriesList(String value, int? vendorId) async {
    ...
    try {
      ...
      print("Yess" + categoryListResponse.message.toString());
