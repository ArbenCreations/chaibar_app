...
class _OrderOverviewScreenState extends State<OrderOverviewScreen>
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: ListView.builder(
                                                shrinkWrap: true,
                                                itemCount: widget.data?.order
                                                    ?.orderItems?.length,
                                                itemBuilder: (context, index) {
                                                  var item = widget.data?.order
                                                      ?.orderItems?[index];
  ...
  Widget _buildBillingDetail(String title, String value,
      {bool isTotal = false}) {
    return Padding(
