...
#if __has_include(<apple_pay_flutter/ApplePayFlutterPlugin.h>)
#import <apple_pay_flutter/ApplePayFlutterPlugin.h>
#else
@import apple_pay_flutter;
#endif
...
#if __has_include(<flutter_broadcasts/FlutterBroadcastsPlugin.h>)
#import <flutter_broadcasts/FlutterBroadcastsPlugin.h>
#else
@import flutter_broadcasts;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  [ApplePayFlutterPlugin registerWithRegistrar:[registry registrarForPlugin:@"ApplePayFlutterPlugin"]];
  ...
  [FlutterBroadcastsPlugin registerWithRegistrar:[registry registrarForPlugin:@"FlutterBroadcastsPlugin"]];
