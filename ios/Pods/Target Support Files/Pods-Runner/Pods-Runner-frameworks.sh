...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/apple_pay_flutter/apple_pay_flutter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_broadcasts/flutter_broadcasts.framework"
